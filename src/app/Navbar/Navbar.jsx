...
const Navbar = () => {
  return (
            ...
            <div className='fixed top-0 z-50 flex items-center justify-between bg-transparent lg:px-global px-[19px] pt-[24px] lg:px-[128px] lg:pt-[34.351px] pb-[10px] w-full mobile:text-[1.6rem] transition-colors duration-300 text-white mx-auto container '>
