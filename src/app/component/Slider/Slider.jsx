...
export default function Slider() {
    return (
        <div className='min-h-screen h-[165vh] text-center mobile:mb-[-16rem] overflow-hidden container mx-auto'>
            <div className='flex items-center h-full gap-[2.35rem] screens-showcase rotate-[-10deg]' >
                ...
                <img loading='lazy' width="644" height="1400" decoding='async' data-nimg='1' className="md:w-[8.16rem] md:h-[17.75rem] bg-black rounded-[1.1rem] border-[.09rem] border-black w-auto h-[25.75rem]" srcSet='./mobile/6.webp 1x ,./mobile/6.webp 2x ' src="./mobile/6.webp" alt="" />
