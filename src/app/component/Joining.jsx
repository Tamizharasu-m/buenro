        ...
        <div>
            <div className='pt-[.94rem] pb-[4.rem] flex flex-row justify-center members-cards mobile:pt-[3rem]'>
                ...
                <div className='z-10 shrink-0 will-change-transform'>
                    <img loading='lazy' width="650" height="650" decoding='async' data-nimg="1" className='w-[8.9rem] h-[8.9rem] mx-auto rounded-full mb-[.87rem] object-cover border-[.4rem] border-white  mobile:w-[9.8rem] mobile:h-[9.8rem] mobile:mt-[-.9rem]' sizes='(max-width: 1800px) 384px' srcSet='./new.jpg 16w, ./new.jpg 32w ./new.jpg 48w, ./new.jpg 64w, ./new.jpg 96w, ./new.jpg 128w, ./new.jpg 256w, ./new.jpg 384w, ./new.jpg 640w, ./new.jpg 750w, ./new.jpg 828w, ./new.jpg 1080w, ./new.jpg 1200w, ./new.jpg 1920w, ./new.jpg 2048w, ./new.jpg 3840w,' src="./new.jpg" alt="" />
