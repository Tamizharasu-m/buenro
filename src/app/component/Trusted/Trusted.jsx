    ...
    return (
        <div className='relative text-center text-black bg-white-100 three-slidesss'>
            ...
            <div className='md:absolute top-0 left-0 right-0 mx-auto w-[24ch] md:h-screen flex flex-col justify-center gap-[.9rem]  md:pb-[3.1rem] md:min-h-[13rem] md:mt-[0]  md:w-[52%] md:text-[1.1rem] pt-[71px] md:pt-[0] '>
                ...
                <p class="text-regular30 mobile:text-[.759em] mobile:text-[.87rem] ">Transform how you connect with your<br></br> trusted social circles - from private<br></br> members clubs, to leadership networks,<br></br> conferences, and festivals.</p>
            </div>
            <div  className='flex w-full  overflow-hidden   flex-row justify-center gap-[1.4rem] px-[23px] py-[60px] md:py-[0] md:px-[0]  md:hidden'>
                <img id='left-phone'  alt="" loading="lazy" width="645" height="1400" decoding="async" data-nimg="1" class="slides-Image  shadow-xxsm object-cover top-[4.2rem] w-[8.16rem] border-[.09rem] border-black h-[17.75rem] rounded-[1.2rem] md:left-[1rem] " srcSet='./trust/18.jpg 1x, ./trust/18.jpg 2x' src='./trust/18.jpg' />
                <img id="right-phone" alt="" loading="lazy" width="633" height="1400" decoding="async" data-nimg="1" class="slides-Image  object-cover top-[4.2rem] w-[8.16rem] border-[.09rem] border-black h-[17.75rem] rounded-[1.2rem] md:left-[1rem] mobile:min-h-[17rem] mobile:h-[auto] mobile:w-[47%]" srcSet='./trust/2.jpg 1x, ./trust/2.jpg 2x' src='./trust/2.jpg' />
            </div>
            <div className='mx-auto slides-part w-[25ch] md:h-[100vh] flex flex-col justify-center gap-[.9rem] md:pt-[2.9em] md:pb-[3.2em] md:min-h-[13rem]  md:w-[52%] md:text-[1.1rem] pb-[1.3rem] mobile:w-[85%] mobile:gap-[2rem] mobile:text-[1.26rem] pt-[71px] '>
                ...
                <p class="text-regular30 mobile:text-[.759em] mobile:text-[.87rem] "><span class="text-[#999999]">Whether it's a local gathering, an exciting<br></br> trip, or a stay at a unique property,</span> easily<br></br> find and become part of events and<br></br> groups that match your interests.</p>
            </div>
            <div className='flex w-full overflow-hidden  md:hidden flex-row  justify-center  px-[23px] py-[60px] md:py-[0] md:px-[0] gap-[1.4rem]  '>
                <img id="left-phone1" alt="" loading="lazy" width="644" height="1400" decoding="async" data-nimg="1" class="slides-Image  shadow-xxsm object-cover top-[4.2rem] w-[8.16rem] border-[.09rem] border-black h-[17.75rem] rounded-[1.2rem] md:left-[1rem] " srcSet='./trust/19.jpg 1x, ./trust/19.jpg 2x' src='./trust/19.jpg' />
                <img id="right-phone1" alt="" loading="lazy" width="644" height="1400" decoding="async" data-nimg="1" class="slides-Image  object-cover top-[4.2rem] w-[8.16rem] border-[.09rem] border-black h-[17.75rem] rounded-[1.2rem] md:left-[1rem] mobile:w-[47%] mobile:min-h-[17rem] mobile:h-[auto]" srcSet='./trust/20.jpg 1x, ./trust/20.jpg 2x' src='./trust/20.jpg' />
            </div>
            </div>
        </div>
    )
