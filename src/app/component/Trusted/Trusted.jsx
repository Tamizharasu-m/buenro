...
export default function Trusted() {
    return (
        <div className='container relative mx-auto text-center text-black bg-white-100'>
            ...
            <div className='mx-auto slides-part w-[24ch] md:h-screen flex flex-col justify-center gap-[.9rem]  md:pb-[3.1rem] md:min-h-[13rem] md:mt-[0] md:justify-between md:w-[52%] md:text-[1.1rem] mobile:w-[85%] mobile:gap-[2rem] mobile:text-[1.26rem] pt-[71px] md:pt-[0] '>
            ...
            <div className='mx-auto slides-part w-[25ch] md:h-[100vh] flex flex-col justify-center gap-[.9rem] md:pt-[2.9em] md:pb-[3.2em] md:min-h-[13rem] md:justify-between md:w-[52%] md:text-[1.1rem] pb-[1.3rem] mobile:w-[85%] mobile:gap-[2rem] mobile:text-[1.26rem] pt-[71px] '>
