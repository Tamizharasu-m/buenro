    ...
    return (
        <div className='lg:h-[100vh] three-slides h-[80vh] container mx-auto overflow-hidden'>
            <div className='flex flex-col justify-center h-full lg:h-screen'>
                ...
                <div id="left-connect" className='ts-slides w-[7rem] h-[7rem] absolute lg:w-[9.96rem] lg:h-[9.96rem] overflow-hidden rounded-[1.25rem] translate-x-[11.2rem] md:w-[8.46rem] md:h-[8.46rem]'>
                    ...
                    <div id="right-connect" className='ts-slides w-[7rem] h-[7rem] absolute lg:w-[9.96rem] lg:h-[9.96rem] overflow-hidden rounded-[1.25rem] translate-x-[-11.2rem] md:w-[8.46rem] md:h-[8.46rem] '>
