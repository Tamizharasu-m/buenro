...
export default function Globally() {
    return (
        <div className='relative flex flex-col properties bg-white-100 h-[100vh] w-full items-center justify-start  pt-[1rem] pb-[3rem] mobile:h-[200vh] container mx-auto'>
