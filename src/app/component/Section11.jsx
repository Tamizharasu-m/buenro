...
export default function Section11() {
    return (
        <div className='scs-container pb-[10%] md:flex w-full justify-center mt-[calc(1rem+15vh)] gap-[2rem] md:flex-row md:items-center mobile:px-[1.2rem] mobile:mt-[5rem]'>
