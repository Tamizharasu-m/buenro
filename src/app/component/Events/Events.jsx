...
export default function Events() {
    return (
        <div className='scs-container pb-[10%] md:flex w-full justify-center mt-[calc(1rem+15vh)] gap-[2rem] md:flex-row md:items-center mobile:px-[1.2rem] mobile:mt-[5rem] px-[22.464px] container mx-auto'>
            <div className='flex flex-col sc-col gap-[2rem]'>
                <div className='h-[23.6rem] overflow-hidden bg-yellow-grad px-[1.2rem] capitalize gap-[1rem] pt-[1.6rem] text-center w-[15.22rem] rounded-[1.3rem] items-center border-[.09rem] border-black flex flex-col mobile:w-full mobile:pt-[2.2rem] mobile:border-[.16rem] mobile:px-[1rem] mobile:gap-[1.4rem] mobile:rounded-[2.2rem] mobile:h-[38rem]'>
                    ...
                    <img alt="" loading="lazy" width="644" height="1400" decoding="async" data-nimg="1" class="w-[8.3em] rounded-[1rem] h-[auto] border-[.06em] border-black mobile:text-[1.5rem]" srcSet='./section11/8.webp 1x, ./section11/8.webp 2x' src='./section11/8.webp' />
                </div>
                <div className='h-[24.9rem] overflow-hidden bg-yellow-grad px-[1.2rem] capitalize gap-[1rem] pt-[1.6rem] text-center w-[15.22rem] rounded-[1.3rem] items-center border-[.09rem] border-black flex flex-col mobile:w-full mobile:pt-[2.2rem] mobile:border-[.16rem] mobile:px-[1rem] mobile:gap-[1.4rem] mobile:rounded-[2.2rem] mobile:h-[38rem]'>
                    ...
                    <img alt="" loading="lazy" width="644" height="1400" decoding="async" data-nimg="1" class="w-[8.3em] rounded-[1em] h-[auto] border-[.06em] border-black mobile:text-[1.5rem]" srcSet='./section11/14.webp 1x, ./section11/14.webp 2x' src='./section11/14.webp' />
                </div>
            </div>
            <div className='flex flex-col sc-col gap-[2rem] pt-[1.6rem] md:pt-0'>
                ...
                <img alt="" loading="lazy" width="644" height="1400" decoding="async" data-nimg="1" class="w-[8.3em] rounded-[1em] h-[auto] border-[.06em] border-black mobile:text-[1.5rem]" srcSet='./section11/11.webp 1x, ./section11/11.webp 2x' src='./section11/11.webp' />
                </div>
                <div className='h-[16rem] overflow-hidden bg-violet-grad px-[1.2rem] capitalize gap-[1rem] pt-[1.6rem] text-center w-[15.22rem] rounded-[1.3rem] items-center border-[.09rem] border-black flex flex-col mobile:w-full mobile:pt-[2.2rem] mobile:border-[.16rem] mobile:px-[1rem] mobile:gap-[1.4rem] mobile:rounded-[2.2rem] mobile:h-[23rem]'>
                ...
                <img alt="" loading="lazy" width="644" height="1400" decoding="async" data-nimg="1" class="w-[8.3em] object-cover rounded-[1em] h-[auto] border-[.06em] border-black mobile:text-[1.5rem]" srcSet='./section11/10.webp 1x, ./section11/10.webp 2x' src='./section11/10.webp'/>
                </div>
                <div className='h-[16rem] overflow-hidden bg-violet-grad px-[1.2rem] capitalize gap-[1rem] pt-[1.6rem] text-center w-[15.22rem] rounded-[1.3rem] items-center border-[.09rem] border-black flex flex-col mobile:w-full mobile:pt-[2.2rem] mobile:border-[.16rem] mobile:px-[1rem] mobile:gap-[1.4rem] mobile:rounded-[2.2rem] mobile:h-[23rem]'>
                ...
                <img alt="" loading="lazy" width="644" height="1400" decoding="async" data-nimg="1" class="w-[8.3em] rounded-[1em] h-[76%] object-cover object-top border-[.06em] border-black mobile:text-[1.5rem]" srcSet='./section11/21.webp 1x, ./section11/21.webp 2x' src='./section11/21.webp' />
                </div>
            </div>
        </div>
    )
