...
export default function Footer() {
    return (
        <div id='footer' className='footer'>
            <div className='relative h-[101vh] w-full z-[-1]'></div>
            <section className='fixed bottom-[0] z-[0] h-[100vh]'>
                <div className='flex justify-center h-screen text-white bg-black footer-content-100-col fixed top-[0] w-full z-[-2] items-center pb-[5.9rem]'>
                    ...
                    <div className='fixed top-[0] w-full h-full z-[2]'></div>
